  ...
  render() {
    return (
      <div>
        ...
        <p>There are currently {this.state.players.length} players</p>
        <p>competing to win : {web3.utils.fromWei(this.state.balance)} eth</p>
        ...
        onSubmit={this.onSubmit}>
          ...
          <div>
            <label>Amount of ether to enter with?</label>
            <input
